...
class KillSwitch:
    def __init__(self, audit, q):
        self.audit = audit; self.q = q; self.tripped = False
...
class ToolGate:
    ...
    def bankr_prompt(self, prompt: str) -> dict:
        ...
        trade_words = ["buy", "sell", "swap"]  # ✅ SIRF YEH!
        ...
        # ✅ SIRF trade_words check karo - always_blocked already handled
...
if __name__ == "__main__":
    ...
    EXECUTION = os.environ.get("EXECUTION", "dry_run")  # "dry_run" ya "live"
